...
const altimages = ["eye", "white", "flowers", "ancientart", "butterfly"]
...
for (let i = 0; i < 5; i++) {
    ...
    newImage.addEventListener("click", () => {
        ...
        displayedImage.setAttribute('alt', altimages[i]);
    })
...
btn.addEventListener("click", () => {
    const currentButton = btn.getAttribute("class");
    console.log(currentButton);
    if (currentButton === "dark") {
